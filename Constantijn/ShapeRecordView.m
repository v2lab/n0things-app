...
- (id)initWithShapeRecord:(ShapeRecord *)shapeRecord {
    self = [super init];
    if (self) {
        path = [UIBezierPath bezierPath];
        //self.backgroundColor = [UIColor colorWithRed:[(NSNumber *)[shapeRecord.color objectAtIndex:0] intValue] / 255. green:[(NSNumber *)[shapeRecord.color objectAtIndex:1] intValue] / 255. blue:[(NSNumber *)[shapeRecord.color objectAtIndex:2] intValue] / 255. alpha:.5];
